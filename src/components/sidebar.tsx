...
const SideNavBar = (props: Props) => {
    ...
    return (
        <div className={`p-2 items-center flex flex-col w-[100px] space-y-9 shadow-md shadow-purple-400 h-screen sticky top-0 bg-white z-20 `}>
            <Image
                src="/logo.png"
                alt=""
                width={50}
            ...
            {menu.map((item, index) => (
                ...
                <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    className={`w-10 h-10 hover:text-purple-500 hover:bg-purple-100 p-2 cursor-pointer rounded-lg', ${index == activeIndex ?
